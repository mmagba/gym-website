...
export const programs = [
    {
        ...
        icon: <SiOpenaigym />,
        title: "Program One",
        info: "Success is not for the chosen few, but for the few who choose.",
        path: "/programs/111"
    },
    {
        id: 2,
        icon: <SiOpenaigym />,
        title: "Program Two",
        info: "It's never too late to be what you might have been. Keep chasing your dreams.",
        path: "/programs/222"
    },
    {
        id: 3,
        icon: <SiOpenaigym />,
        title: "Program Three",
        info: "You are capable of more than you know. Choose a goal and pursue it relentlessly.",
        path: "/programs/333"
    },
    {
        id: 4,
        icon: <SiOpenaigym />,
        title: "Program Four",
        info: "Every day is a new opportunity to be better than yesterday. Seize it.",
        path: "/programs/444"
    }
]
